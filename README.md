...
- **Lanvac station layer (R54):** [`docs/LANVAC_STATION.md`](./docs/LANVAC_STATION.md) — read UI shipped (zones, Historic, panel chip). Writes / on-test next, `O5985` only. Before multi-site.
