...
- **Multi-site / extra logins (R53 slices 1–2 shipped and audited):** [`docs/MULTI_SITE_ACCOUNTS.md`](./docs/MULTI_SITE_ACCOUNTS.md) — schema + `resolvePortalSession`. Next is last-owner revoke / delete confirm copy, then admin UI and switcher. Required before county-style import.
