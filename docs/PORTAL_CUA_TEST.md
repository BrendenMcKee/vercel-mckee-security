...
1. Clients tab. One connected mode toggle: **New client** | **Add site to an account**. Not two disconnected buttons and not one combined wizard. Close dismisses the form.
