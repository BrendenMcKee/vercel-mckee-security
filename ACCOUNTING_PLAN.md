...
**Last updated:** 2026-08-15 (DennisPC live file is `McKee Security July 14.QBW`; TSheets follows whichever company file is open; QB To Dos are a one-time device import, then the portal owns the list)
