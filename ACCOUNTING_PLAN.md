...
7. **The Lanvac contact-list export and API (done).** Full Excel is in hand. API contract ingested and write-tested 2026-08-16 on `O5985`. Thank-you email sent. Vercel env set (does not turn on writes). Official city is the live directory string. Emails stay. This does not block QuickBooks work.
