...
- [x] **Staff help tips + create-form grouping hint + client header identity** (2026-09-12). Reusable (i) modal on grouping sign-off, automatic onboarding, and New client / Add site. Copy written for live mail. Draft same-name / same-email / civic hint while staff type. Client header shows site name · CODE (Account line when useful). Switcher is still slice 5.
...
| Date | Milestone |
|------|-----------|
| 2026-09-12 | **Staff (i) help, create-form grouping hint, client header identity.** Click (i) for sign-off, automatic onboarding, and Possible linked account. Copy describes live mail. New client / Add site flags same name, same email, or a civic-looking name without attaching. Client header shows site name · CODE, plus Account when the name differs or there are 2+ sites. Switcher is still slice 5. Next is Appoint account admin and Account-card attach/move. Do not type `GO LIVE`. |
