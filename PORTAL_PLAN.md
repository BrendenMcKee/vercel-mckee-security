...
| Settings tab | locked sign-in email; editable phone and service address; change password while authenticated | save account details; update password | R47. Service-role write of `phone`/`address` only. McKee inbox notified on every change |
