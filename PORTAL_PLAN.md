...
- [x] **Clients list linked-account chip** (2026-08-30). Account column: name + site count when an account has two or more sites. Linked accounts / One site filter. Search by account name. Single-site rows show a dash.
