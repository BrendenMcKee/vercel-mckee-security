...
| Bridge API routes (`/api/qb/poll`, `/api/qb/report`, `/api/qb/mirror`) | Vercel | Per-bridge secret auth; poll returns ready tasks, report stores TxnIDs/errors, mirror ingests read-only snapshots |
