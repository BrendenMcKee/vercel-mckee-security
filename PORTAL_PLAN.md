...
| `email` | text | nullable (invite may omit); unique when set (partial unique index). Client-locked in Settings (R47); admin may still edit the contact/invite email without changing Auth |
