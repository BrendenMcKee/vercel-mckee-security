...
- [x] **Clients list linked-account chip** (2026-08-30). Account name + site count when an account has two or more sites. Linked accounts / One site filter. Search by account name. Single-site rows stay plain.
...
| Date | Milestone |
|------|-----------|
| 2026-08-30 | **Clients list linked-account chip.** Staff Clients tab chips `Account · N sites` when an account has two or more sites, tints that row's email, and can filter Linked accounts vs One site. Search matches the account name. Single-site rows stay plain. Next is slices 4–6. Do not delete the McKee sites. Do not start the Windows QuickBooks bridge or a real import. Do not type `GO LIVE`. |
