...
- [ ] **[HUMAN]** D4: Stripe account; products/prices per 9.1; webhook endpoint registered; keys in Vercel. D6/Q3 confirmed (monitoring paid in portal?). D11: payment instructions + reminder window. Q2 cloud pricing can wait for Track 2. **All code ships Stripe-ready and degrades gracefully until the keys exist** (checkout says "online payment not available yet"; webhook returns 503; the manual rail is fully live)
