...
- **Per-client migration checklist.** Admin client detail and a Billing-tab filter surface each seeded client's state: imported, alarm contacts entered, devices entered, invited, activated. Partially migrated clients are always visible; nothing is silently skipped, and "done or not" never depends on memory.
