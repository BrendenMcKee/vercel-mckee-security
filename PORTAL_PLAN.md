...
- [x] **[HUMAN]** D13 API contract ingested and write-tested 2026-08-16 on `O5985`. Portal station fields shipped (`lanvac_account_code`, `lanvac_city`). Remaining: match Excel CODEs to portal clients at seed time. Device samples are in `ACCOUNTING_GATHER_DATA.md`.
