...
// ---------------------------------------------------------------------------
// Device tracking: accounts start with no devices. Names are free text;
// category is the filter. Clients see the list read-only; every write
// here is admin-only via RLS.
// ---------------------------------------------------------------------------
