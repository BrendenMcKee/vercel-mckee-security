...
export function StarlinkAdminLock() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    setSubmitting(true);
    try {
      const res = await fetch("/api/starlink-admin/unlock", {
        method: "POST",
    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4 py-16">
      <div className="w-full max-w-sm rounded-2xl border border-white/10 bg-surface p-8 shadow-2xl shadow-black/40">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <h1 className="flex items-center gap-2 text-lg font-bold uppercase tracking-wide text-white">
