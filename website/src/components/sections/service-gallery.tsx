            ...
            <StaggerItem key={photo.src}>
              ...
              >
                <Image
                  ...
                  className="object-cover transition-transform duration-[550ms] ease-[cubic-bezier(0.22,1,0.36,1)] md:group-hover:scale-[1.04]"
                ...
                <span
                  className="pointer-events-none absolute inset-0 rounded-2xl ring-1 ring-inset ring-white/0 transition-[box-shadow,transform] duration-[550ms] ease-[cubic-bezier(0.22,1,0.36,1)] md:group-hover:ring-secondary/60"
                  aria-hidden="true"
                />
                {i === 0 && (
